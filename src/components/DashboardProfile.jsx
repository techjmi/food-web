...
const DashboardProfile = () => {
  ...
  return (
    <div className="flex flex-col w-full md:w-3/5 mx-auto h-full pb-3">
      <div className="avatar flex flex-row md:flex-col gap-2 items-center md:shadow-[0] shadow-md md:rounded-none rounded-lg bg-slate-50 w-full p-4 md:bg-white">
        <img
      ...
      <Button className="self-center mt-8" gradientDuoTone="purpleToPink" outline>
        Update Profile
      </Button>
    </div>
  );
